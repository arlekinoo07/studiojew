            ...
            <div className="absolute top-0 z-10 flex w-full flex-wrap items-center justify-between gap-4 border-b border-white px-4 py-4 text-white sm:px-6 lg:px-10">
                <Link href="/">
                    <div className="flex cursor-pointer">
                        <p className="text-[24px] sm:text-[28px] lg:text-[32px] text-white">studiojew</p>
                        <div className="mt-2 h-[5px] w-[5px] rounded-full border border-white sm:mt-3"></div>
                    </div>
                </Link>
                <div className="order-3 flex w-full flex-wrap justify-center gap-4 text-[13px] font-semibold sm:order-2 sm:w-auto sm:gap-6 sm:text-[16px] lg:order-none lg:gap-8 lg:text-[20px]">
